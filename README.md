- Link para o notebook através do nbviewer (Recomendado para uma melhor visualização): https://nbviewer.jupyter.org/github/Leonardodsch/churn-prediction/blob/main/Churn-Prediction.ipynb
